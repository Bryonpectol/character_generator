...
let occupations = ["Account Collectors",
"Accountants",
"Accounting Clerks",
"Actors",
"Actuaries",
...
"Aerospace Engineers",
"Agent and Business Manager of Artists, Performers, and Athletess",
...
let lastNum = Math.floor(Math.random() * lastNames.length);
...
if(strUser == "Other") {
    ...
    console.log(bothNum + " : " + bothArray[bothNum] + " : " + bothArray.length);
    ...
    if(ageNum > 16) {
        ...
        let MSEl = document.createElement("p");
        ...
        MSEl.textContent = "Marital Status: " + maritalStatis[1];
